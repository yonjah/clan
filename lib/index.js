(function () {
	...
	function createMixinFunction() {
		function ClanMix (target) {
			if (this && this.constructor === ClanMix) { //called with new
				if (target) {
				...
				target = target || {};
				_.extend(target, ClanMix.prototype);
				Object.keys(target).forEach(superExtend.bind(null, target, target, ClanMix.prototype));
